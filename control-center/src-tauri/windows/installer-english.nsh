...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "an existing version of ${PRODUCTNAME} is installed on your system. it's recommended that you uninstall the current version before installing.$\nselect the operation you want to perform and click next to continue."
